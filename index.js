...
var State = (function (_Component) {
  ...
  _createClass(State, [{
    ...
    key: 'contextTypes',
    value: {
      hoistedState: _react.PropTypes.object
    },
    enumerable: true
  }]);
...
var Hoist = (function (_Component2) {
  _inherits(Hoist, _Component2);

  function Hoist() {
    _classCallCheck(this, Hoist);

    _get(Object.getPrototypeOf(Hoist.prototype), 'constructor', this).apply(this, arguments);
  }
  ...
  _createClass(Hoist, [{
    ...
    value: { hoistedState: _react.PropTypes.object },
    enumerable: true
  }, {
    key: 'propTypes',
    value: {
      visit: _react.PropTypes.func
    },
    enumerable: true
  }]);
